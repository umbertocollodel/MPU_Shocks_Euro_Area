...
#   Parallelised with furrr (20 workers). Per-call RDS caching for resumability.
#
# Outputs:
...
#   source("run_full_ensemble_p1.R")   # from code/ directory
...
# ==============================================================================
# 3. OPENROUTER CALLER  — verbatim from micro_pilot_p1.R
# ==============================================================================
...
if (n_missing == 0) {
  ...
  parse_one_run <- function(filepath) {
    tryCatch({
      ...
      # --- exact logic from 08clean_llm_result.R ---
      result <- response %>%
        readr::read_delim(
          delim         = "|",
          trim_ws       = TRUE,
