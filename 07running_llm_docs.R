...
Output: for each interest rate horizon (short-term: 3 months-2 years, long-term: 5-10 years), provide the following:
...
Format output: Present results in a table with 5 columns (one per task) and 2 rows (one per horizon). 
The table should have dimensions 2×5. 
