#===============================================================================
# PROMPT DEFINITIONS FOR LLM MODELS
#===============================================================================
# Project: Interpreting the Interpreter - ECB Communication Analysis
# Author: Umberto Collodel
# Institution: Central Bank of Malta
#
# This file contains all prompt templates used across different model variants:
#   - prompt_naive: Basic prompt without historical context
#   - prompt_history_surprises: Includes historical volatility context
#   - prompt_anchor_values: Provides pre-conference OIS rates
#   - prompt_microstructure: Includes institutional trader roles
#
# Usage:
#   source("config/prompts.R")
#   prompt <- prompt_naive  # Select desired prompt
#===============================================================================


# Naive Prompt (no historical context) ----------------------------------------
prompt_naive <- c("
Context:
...
# Historical Surprises Prompt (includes past volatility) ----------------------
...
# Anchor Values Prompt (provides pre-conference rates) ------------------------
...
# Microstructure Prompt (includes institutional roles) ------------------------
